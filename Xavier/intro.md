...
:::tip
本站已接入阿里云CDN/Vercel CDN进行全球加速。如遇无法打开的情况，请反馈给服主：CerealAxis@XavierMC.top。欢迎加入我们的[QQ交流群](https://qm.qq.com/q/BiCHWlypxu)！
:::
...
| 睡觉比例 | 50% | |
| 种子 | 服务器种子不公开并做了防爆破处理 | |
| view-distance | 服务器始终以最大值向玩家发送地图数据。可视距离仅由玩家的客户端决定。 | |
