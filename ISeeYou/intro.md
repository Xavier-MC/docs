...
| 指令                                      | 功能描述                                                             | 示例                                                                             |
|-----------------------------------------|------------------------------------------------------------------|--------------------------------------------------------------------------------|
| `photographer create <name> [location]` | 创建摄像机                                                            | `/photographer create MyCamera` |
|                                         | - `<name>`：摄像机名称，长度限制在5到16个字符之间                                  |                                                                                |
|                                         | - `[location]`（可选）：摄像机位置，格式为x y z坐标值。若不指定位置，则默认设置为执行命令玩家当前位置 |                                                                              `/photographer create MyCamera <x> <y> <z>`  |
